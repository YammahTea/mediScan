...
const Toast = ({ message, onClose, type = 'error' }) => {
  ...
  return (
    <div className="absolute right-15 bottom-10 z-50 animate-bounce-in">
      <div className={`toast-card ${config.styleClass}`}> {/* only once to setup the css variables (all the inside elements will inherit it)*/}
        ...
        <div className="icon-container">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox={`${config.iconSize}`} strokeWidth={0} fill="currentColor" stroke="currentColor" className="icon">
            {config.icon}
          </svg>
        </div>
        ...
        <svg
          onClick={onClose}
          xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 15" strokeWidth={0} fill="none" stroke="currentColor"
